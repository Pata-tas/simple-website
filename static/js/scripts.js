...
/*=====download cv======*/
let downloadCVBtn = document.querySelector('#downloadCV');

downloadCVBtn.onclick = (e) => {
  e.preventDefault();
  // Create a link element
  const link = document.createElement('a');
  link.href = '../CV.pdf'; // Change this to your CV file name
  link.download = 'John_CV.pdf'; // Name it will be saved as
